...
public class TransitionAdapter extends GenericAdapter<Transition> implements fr.inria.diverse.k3.sle.examples.fsm.fsmmt.Transition {
  ...
  public State getSource() {
    return new fr.inria.diverse.k3.sle.examples.fsm.timedfsm.adapters.fsmmt.StateAdapter(adaptee.getSource()) ;
  }
  ...
  public State getTarget() {
    return new fr.inria.diverse.k3.sle.examples.fsm.timedfsm.adapters.fsmmt.StateAdapter(adaptee.getTarget()) ;
  }
