...
public class ExecutableStateAspect {
  public static void step(final State _self, final char c) {
    _self_ = fr.inria.diverse.k3.sle.examples.fsm.ExecutableStateAspectStateAspectContext.getSelf(_self);
    	      _privk3_step(_self,c); 
  }
  
  public static ExecutableStateAspectStateAspectProperties _self_;
  ...
  protected static void _privk3_step(final State _self, final char c) {
    try {
      ...
      ExecutableTransitionAspect.fire(_head);
    } catch (Throwable _e) {
